...
public class ServletInicio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            usuarioX.setUsuario(request.getParameter("txtUsuario"));
            usuarioX.setContraseña(request.getParameter("txtPass"));
            String respuesta=usuarioXDAO.iniciarSesion(usuarioX);
            if (respuesta.equals("1")) {
                response.sendRedirect("jsfCliente.xhtml");
            }else {
